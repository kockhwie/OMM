...
/// <summary>
/// WebApplicationFactory for OMM.Public that runs in the "Integration" environment.
/// Database startup checks are bypassed so tests run quickly without live Postgres.
/// </summary>
public class PublicWebAppFactory : WebApplicationFactory<OMM.Public.Components.App>
{
